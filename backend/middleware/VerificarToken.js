...
export const JWT_SECRET = process.env.JWT_SECRET || 'micampo_fresco_secret';
export const JWT_EXPIRATION = process.env.JWT_EXPIRES_IN || '24h';
...
export const verificarVendedor = (req, res, next) => {
    try {
        ...
        console.error('Error en AuthVendedor middleware:', error);
        return res.status(500).json({
            error: 'Error interno del servidor',
