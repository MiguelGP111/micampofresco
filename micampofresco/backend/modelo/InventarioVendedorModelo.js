...
import { ejecutarConsulta } from '../configuracion/db.js'; //  nombre exacto y minúscula

export const InventarioModelo = {

  async obtenerInventario() {
    try {
      const inventarios = await ejecutarConsulta(
    ...
    try {
      ...
      const result = await ejecutarConsulta(
        `INSERT INTO inventarios (
          idvendedor, idproducto, cantidad_disponible, precio,
          stock_minimo, stock_maximo, estado,
          ultimo_ingreso, ultimo_salida, created_at, updated_at
        )
